      ...
      <div className={`landing ${darkMode ? 'dark' : ''}`}>
        ...
        <nav className="landing-nav">
          ...
          <div className="nav-links">
            ...
            <a href="https://github.com/AetheraLab" target="_blank" rel="noopener noreferrer" className="nav-link">GitHub</a>
        ...
        <section id="products" className="products-section">
          ...
          <div className="product-showcase">
            <div className="product-content">
              ...
              <button className="product-btn" onClick={() => navigate("/oracle")}>
          ...
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <div className="footer-socials">
                ...
                <a href="https://github.com/AetheraLab" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
            ...
            <div className="footer-links-grid">
              ...
              <div className="footer-column">
                <h4>Resources</h4>
                <a href="https://github.com/AetheraLab" target="_blank" rel="noopener noreferrer">Documentation</a>
                <a href="https://github.com/AetheraLab" target="_blank" rel="noopener noreferrer">GitHub</a>
